...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 16l-4 4 4-4 3.707-3.707a1 1 0 011.414 0L19 15m0-10h.01" />
  </svg>
);

export const BlueskyIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M21.25,2.75a0.25,0.25,0,0,0-.25-0.25H3a0.25,0.25,0,0,0-.25.25v18.5a0.25,0.25,0,0,0,.25.25h18a0.25,0.25,0,0,0,.25-0.25V2.75ZM12,18.06a6.56,6.56,0,0,1-6.56-6.56,6.49,6.49,0,0,1,.12-1.32,0.75,0.75,0,0,1,.84-0.63H7.5a0.74,0.74,0,0,1,.74.65,3.79,3.79,0,0,0,.1.9,4.06,4.06,0,0,0,7.32,0,3.79,3.79,0,0,0,.1-0.9,0.74,0.74,0,0,1,.74-0.65h1.09a0.75,0.75,0,0,1,.84.63,6.49,6.49,0,0,1,.12,1.32A6.56,6.56,0,0,1,12,18.06Z" />
  </svg>
);
